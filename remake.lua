...
-- Fixed for KRNL - Multiple load attempts
local vu1
...
spawn(function()
    ...
    local function SetupMenuToggle()
        ...
        if not mainContainer then
            ...
            for _, child in pairs(fluentUI:GetDescendants()) do
                if child:IsA("Frame") and child.Visible then
                    ...
                    if size > maxSize and size > 10000 then
                        maxSize = size
                        mainContainer = child
                    end
                end
        ...
        local function ToggleMenu()
            ...
            local status = MenuVisible and "SHOWN" or "HIDDEN"
            pcall(function()
                game:GetService("StarterGui"):SetCore("SendNotification", {
                    Title = "Reaper Hub",
                    Text = "Menu is " .. status .. " | Press END to toggle",
                    Duration = 2
                })
            end)
        end
        ...
        for _, desc in pairs(fluentUI:GetDescendants()) do
            if desc:IsA("ImageButton") or (desc:IsA("TextButton") and desc.Name:lower():find("minim")) then
                desc.MouseButton1Click:Connect(ToggleMenu)
            end
        end
    ...
    local retry = 0
    while retry < 3 and not MenuToggled do
        MenuToggled = SetupMenuToggle()
        if not MenuToggled then retry = retry + 1 task.wait(1) end
    end
end)

-- TAB DEFINITIONS
local vu3 = {
    ["Info"] = v2:AddTab({ ["Title"] = "Information" }),
    ["Main"] = v2:AddTab({ ["Title"] = "Main Farm" }),
    ["Sea"] = v2:AddTab({ ["Title"] = "Sea Events" }),
    ["Item"] = v2:AddTab({ ["Title"] = "Items & Upgrades" }),
    ["Setting"] = v2:AddTab({ ["Title"] = "Settings" }),
    ["Status"] = v2:AddTab({ ["Title"] = "Webhook" }),
    ["Stats"] = v2:AddTab({ ["Title"] = "Stats" }),
    ["Player"] = v2:AddTab({ ["Title"] = "Player" }),
    ["Teleport"] = v2:AddTab({ ["Title"] = "Teleport" }),
    ["Fruit"] = v2:AddTab({ ["Title"] = "Devil Fruit" }),
    ["Raid"] = v2:AddTab({ ["Title"] = "Raid" }),
    ["Race"] = v2:AddTab({ ["Title"] = "Race V4" }),
    ["Shop"] = v2:AddTab({ ["Title"] = "Shop" }),
    ["Misc"] = v2:AddTab({ ["Title"] = "Miscellaneous" })
}
...
-- SEA VALIDATION
Sea1, Sea2, Sea3 = false, false, false
...
function Tween(p176)
    ...
    pcall(function()
        ...
        local v177 = (p176.Position - player.Character.HumanoidRootPart.Position).Magnitude
        local v178 = TweenSpeed
        local v179 = TweenInfo.new(v177 / v178, Enum.EasingStyle.Linear)
        local v180 = game:GetService("TweenService"):Create(player.Character.HumanoidRootPart, v179, {
            ["CFrame"] = p176
        })
        v180:Play()
...
vu3.Info:AddButton({
    ...
    ["Description"] = "Discord",
    ["Callback"] = function()
        setclipboard(tostring("https://discord.gg/RPVTDFZyhw"))
    end
})
...
vu3.Main:AddToggle("ToggleLevel", {
    ...
    if p267 == true then
        ...
        wait()
        game:GetService("StarterGui"):SetCore("SendNotification", {
            Title = "Off Farm Level";
            Text = "";
            Duration = 2;
        })
    end
end)
vu4.ToggleLevel:SetValue(false)
spawn(function()
    while task.wait() do
                        ...
                        for _, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and v.Name == Ms then
                                repeat
                                    ...
                                    MonFarm = v.Name
                                until not _G.AutoLevel or not v.Parent or v.Humanoid.Health <= 0 or game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == false
                                bringmob = false
                            end
                        end
                    else
...
vu4.ToggleMobAura:SetValue(false)
spawn(function()
    while wait() do
        if _G.AutoNear then
            pcall(function()
...
vu4.ToggleCastleRaid:SetValue(false)
spawn(function()
    while wait() do
...
vu4.ToggleHakiFortress:SetValue(false)
    ...
    while wait() do
        if _G.AutoCollectBerry then
            ...
            if v312 then
                ...
                vu1:Notify({
                    ["Title"] = "Strix",
                    ["Content"] = "Found Berry : " .. tostring(v313),
                    ["Duration"] = 10
                })
            else
                Hop()
...
if Sea3 then
    ...
    spawn(function()
        ...
        pcall(function()
            ...
            while wait() do
                ...
                vu426:SetDesc("You have: " .. tostring(v427) .. " Bones")
            end
        end)
    end)
    ...
    spawn(function()
        ...
        while wait() do
            if _G.AutoBone then
                pcall(function()
					-- upvalues: (ref) vu429
                    local v430 = game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text
                    if not string.find(v430, "Demonic Soul") then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
                    end
                    if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
                        Tween(vu429)
                        if (vu429.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 3 then
        ...
        while wait() do
            if _G.AutoBoneNoQuest then
                pcall(function()
					-- upvalues: (ref) vu435
                    Tween(vu435)
                    local _ = (vu435.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 3
    ...
    vu4.ToggleRandomBone:SetValue(false)
    spawn(function()
        while wait() do
...
if Sea3 then
    vu3.Main:AddSection("Cake Prince")
                ...
                if string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) ~= 88 then
                    if string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) ~= 87 then
                        if string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) ~= 86 then
                            vu441:SetDesc("Cake Prince: true")
                        else
                            vu441:SetDesc("Remaining: " .. string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"), 39, 39) .. " ")
                        end
                    else
                        vu441:SetDesc("Remaining: " .. string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"), 39, 40) .. "")
                    end
                else
                    vu441:SetDesc("Remaining: " .. string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"), 39, 41) .. "")
                end
            end)
        end
    end)
    ...
    vu4.ToggleSpawnCake:SetValue(true)
end
spawn(function()
    while wait() do
...
if Sea2 then
    ...
    vu4.ToggleVatChatKiDi:SetValue(false)
    spawn(function()
        while wait() do
            pcall(function()
...
vu4.ToggleAutoFarmBoss:SetValue(false)
spawn(function()
    while wait() do
        if _G.AutoBoss then
            pcall(function()
...
vu4.ToggleMaterial:SetValue(false)
spawn(function()
    while task.wait() do
...
if Sea3 then
    vu3.Sea:AddSection("Kitsune Island")
    ...
    function UpdateKitsune()
        ...
        if game.Workspace._WorldOrigin.Locations:FindFirstChild("Kitsune Island") then
            vu487:SetDesc("Kitsune Island : Found")
        else
            vu487:SetDesc("Kitsune Island : Not Found")
        end
    end
    spawn(function()
        pcall(function()
    ...
    vu3.Sea:AddToggle("ToggleTPKitsune", {
        ["Title"] = "TP to Kitsune Island",
        ["Description"] = "",
        ["Default"] = false
    }):OnChanged(function(p488)
        _G.TweenToKitsune = p488
    end)
    vu4.ToggleTPKitsune:SetValue(false)
    spawn(function()
        local v489 = nil
        while not v489 do
    ...
    vu3.Sea:AddToggle("ToggleCollectAzure", {
        ["Title"] = "Collect Azure Embers",
        ["Description"] = "",
        ["Default"] = false
    }):OnChanged(function(p495)
        _G.CollectAzure = p495
    end)
    vu4.ToggleCollectAzure:SetValue(false)
    spawn(function()
        while wait() do
    ...
    local function v555(p521, pu522, pu523, pu524, pu525)
        ...
        local v526 = vu3.Sea:AddToggle(pu522, {
            ["Title"] = p521,
            ["Default"] = false
        })
        vu4[pu522]:SetValue(false)
    ...
    v555("Find Prehistoric", "AutoFindPrehistoric", v520.Prehistoric, "PrehistoricIsland", "Prehistoric Island Found")
    ...
    vu3.Sea:AddButton({
        ["Title"] = "Teleport to Hunting Area",
        ["Description"] = "",
        ["Callback"] = function()
    ...
    vu4.ToggleTerrorshark:SetValue(false)
    _G.IsFlying = false
    spawn(function()
        while wait() do
                ...
                pcall(function()
                    ...
                    if v602 and v602:FindFirstChild("Humanoid") then
                        if v602.Humanoid.Health < 6000 and not _G.IsFlying then
                            _G.IsFlying = true
                            Tween(CFrame.new(v602.HumanoidRootPart.Position.X, 360, v602.HumanoidRootPart.Position.Z))
                        end
    ...
    vu4.TogglePiranha:SetValue(false)
    spawn(function()
        while wait() do
    ...
    vu4.ToggleShark:SetValue(false)
    spawn(function()
        while wait() do
    ...
    vu4.ToggleFishCrew:SetValue(false)
    spawn(function()
        while wait() do
    ...
    vu3.Sea:AddToggle("ToggleShip", {
        ["Title"] = "Auto Ship Hunt",
        ["Description"] = "",
        ["Default"] = false
    }):OnChanged(function(p622)
        _G.Ship = p622
    end)
    vu4.ToggleShip:SetValue(false)
    ...
    vu4.ToggleGhostShip:SetValue(false)
    function CheckPirateBoat()
        local v630 = next
    ...
    vu3.Main:AddToggle("ToggleElite", {
        ["Title"] = "Farm Elite Boss",
        ["Description"] = "",
        ["Default"] = false
    }):OnChanged(function(p653)
        _G.AutoElite = p653
    end)
    vu4.ToggleElite:SetValue(false)
    spawn(function()
        while task.wait() do
...
if Sea3 then
    vu3.Sea:AddSection("Mirage Island")
    ...
    spawn(function()
        ...
        pcall(function()
			-- upvalues: (ref) vu658
            while wait() do
                vu658:SetDesc("Mirage Island: " .. MirageStatus .. " | Full Moon: " .. FullMoonStatus)
            end
        end)
    end)
    vu3.Sea:AddButton({
...
vu4.ToggleTweenGear:SetValue(false)
spawn(function()
    pcall(function()
        while wait() do
...
vu4.Togglelockmoon:SetValue(false)
spawn(function()
    while wait() do
        pcall(function()
...
vu4.ToggleAutoSaber:SetValue(false)
spawn(function()
    while task.wait() do
...
vu4.ToggleAutoPoleV1:SetValue(false)
...
vu4.ToggleAutoSaw:SetValue(false)
...
vu4.ToggleAutoWarden:SetValue(false)
...
if Sea3 then
    ...
    vu4.ToggleHallow:SetValue(false)
    spawn(function()
        while wait() do
    ...
    vu3.Item:AddToggle("ToggleTushita", {
        ["Title"] = "Tushita",
        ["Description"] = "",
        ["Default"] = false
    ...
    vu4.ToggleTushita:SetValue(false)
    spawn(function()
		-- ::l0::
        while true do
            repeat
...
vu3.Item:AddToggle("ToggleAutoCanvander", {
    ["Title"] = "Canvander",
    ["Description"] = "",
    ["Default"] = false
...
vu4.ToggleAutoCanvander:SetValue(false)
...
vu4.ToggleAutoMusketeerHat:SetValue(false)
spawn(function()
    pcall(function()
        while wait(0.1) do
                                ...
                                if vu725.Name == "Captain Elephant" then
                                    ...
                                    repeat
                                        ...
                                        pcall(function()
                                            ...
                                            Tween(vu725.HumanoidRootPart.CFrame * Pos)
                                            vu725.HumanoidRootPart.CanCollide = false
                            ...
                            if vu729.Name == "Forest Pirate" then
                                repeat
                                    ...
                                    pcall(function()
                                        ...
                                        Tween(vu729.HumanoidRootPart.CFrame * Pos)
...
vu4.ToggleAutoObservationV2:SetValue(false)
spawn(function()
    while wait() do
        pcall(function()
...
vu4.ToggleAutoRainbowHaki:SetValue(false)
spawn(function()
    pcall(function()
        while wait(0.1) do
...
vu3.Item:AddToggle("ToggleAutoSkullGuitar", {
    ["Title"] = "Skull Guitar",
    ["Description"] = "",
    ["Default"] = false
...
vu4.ToggleAutoSkullGuitar:SetValue(false)
spawn(function()
    while wait() do
        pcall(function()
...
vu4.ToggleAutoBuddy:SetValue(false)
...
vu4.ToggleAutoDualKatana:SetValue(false)
spawn(function()
    while wait() do
        pcall(function()
...
if Sea2 then
    ...
    vu4.ToggleFactory:SetValue(false)
    spawn(function()
		-- ::l0::
        while true do
            repeat
...
vu4.ToggleAutoFarmSwan:SetValue(false)
spawn(function()
    pcall(function()
        while wait() do
                        ...
                        if vu826.Name == "Don Swan" and (vu826.Humanoid.Health > 0 and (vu826:IsA("Model") and (vu826:FindFirstChild("Humanoid") and vu826:FindFirstChild("HumanoidRootPart")))) then
                            repeat
                                ...
                                pcall(function()
                                    ...
                                    Tween(vu826.HumanoidRootPart.CFrame * Pos)
                                    AttackNoCoolDown()
                                end)
...
vu3.Item:AddToggle("ToggleAutoRengoku", {
    ["Title"] = "Rengoku",
    ["Description"] = "",
    ["Default"] = false
...
vu4.ToggleAutoRengoku:SetValue(false)
spawn(function()
    pcall(function()
        while wait() do
...
if Sea2 or Sea3 then
    ...
    vu4.ToggleHakiColor:SetValue(false)
    spawn(function()
        while wait() do
...
if Sea2 then
    ...
    vu4.ToggleSwordLengend:SetValue(false)
    spawn(function()
        while wait() do
            pcall(function()
...
if Sea2 then
    ...
    vu4.ToggleEvoRace:SetValue(false)
    spawn(function()
        pcall(function()
            while wait(0.1) do
...
vu4.ToggleAutoT:SetValue(false)
spawn(function()
    while wait() do
        pcall(function()
            if _G.AutoT then
...
vu4.ToggleAutoY:SetValue(false)
spawn(function()
    while wait() do
        pcall(function()
            if _G.AutoY then
...
vu4.ToggleAutoKen:SetValue(false)
spawn(function()
    while wait() do
        pcall(function()
            if _G.AutoKen then
...
vu4.ToggleSaveSpawn:SetValue(false)
spawn(function()
    while wait() do
        pcall(function()
...
vu3.Setting:AddToggle("ToggleBringMob", {
    ["Title"] = "Bring Mob",
    ["Description"] = "",
    ["Default"] = true
...
vu4.ToggleBringMob:SetValue(true)
spawn(function()
    while wait() do
        pcall(function()
...
vu4.ToggleRemoveNotify:SetValue(false)
spawn(function()
    while wait() do
...
vu3.Setting:AddSection("Mastery Skills Settings")
...
vu3.Status:AddParagraph({
    ...
    ["Content"] = "━━━━━━━━━━━━━━━━━━━━━━━━\n" .. 
        "Display Name: " .. game.Players.LocalPlayer.DisplayName .. " (@" .. game.Players.LocalPlayer.Name .. ")\n" .. 
        ...
        "Health: " .. math.floor(game.Players.LocalPlayer.Character.Humanoid.Health) .. "/" .. math.floor(game.Players.LocalPlayer.Character.Humanoid.MaxHealth) .. "\n" .. 
        "Energy: " .. math.floor(game.Players.LocalPlayer.Character.Energy.Value) .. "/" .. math.floor(game.Players.LocalPlayer.Character.Energy.MaxValue) .. "\n" .. 
...
local vu879 = vu3.Status:AddParagraph({
    ["Title"] = "Server Uptime",
    ["Content"] = ""
})
local function vu884()
    ...
    local v883 = v880 % 60
    -- แก้ไขจาก: %02d Tiđếng-%02d Phút-%02d Giây
vu879:SetDesc(string.format("%02d Hours : %02d Minutes : %02d Seconds", v881, v882, v883))
end
    ...
    pcall(function()
        ...
        while wait() do
            if game:GetService("Workspace").Map:FindFirstChild("FrozenDimension") then
                vu885:SetDesc("Status : Found")
            else
                vu885:SetDesc("Status : Not Found")
            end
        end
    end)
end)
vu3.Status:AddInput("Input", {
    ["Title"] = "Job ID",
    ["Default"] = "",
    ["Placeholder"] = "Server Joiner Settings",
    ["Numeric"] = false,
    ["Finished"] = false,
...
vu4.ToggleTeleport:SetValue(false)
spawn(function()
    while wait() do
...
vu4.ToggleWalkonWater:SetValue(true)
spawn(function()
    while task.wait() do
        pcall(function()
...
vu4.ToggleSpeedRun:SetValue(true)
spawn(function()
    while wait() do
        if InfAbility then
            InfAb()
...
vu4.ToggleNoClip:SetValue(true)
spawn(function()
    pcall(function()
        game:GetService("RunService").Stepped:Connect(function()
            if _G.LOf then
...
vu4.ToggleEnablePvp:SetValue(false)
spawn(function()
    pcall(function()
        while wait() do
...
vu4.ToggleAutoSea2:SetValue(false)
spawn(function()
    while wait() do
...
vu4.ToggleAutoSea3:SetValue(false)
spawn(function()
    while wait() do
        if _G.AutoSea3 then
            pcall(function()
...
vu3.Teleport:AddSection("TpIsland")
if Sea1 then
    IslandList = {
        "WindMill",
        "Marine",
...
local v928 = vu3.Teleport:AddDropdown("DropdownIsland", {
    ["Title"] = "Select Island",
    ["Description"] = "",
    ["Values"] = IslandList,
    ["Multi"] = false,
...
vu4.ToggleStore:SetValue(false)
spawn(function()
    while task.wait() do
...
vu4.ToggleRandomFruit:SetValue(false)
spawn(function()
    pcall(function()
        while wait() do
...
vu4.ToggleCollectTP:SetValue(false)
spawn(function()
    while wait() do
...
vu4.ToggleCollect:SetValue(false)
spawn(function()
    while wait() do
...
vu4.ToggleEspFlower:SetValue(false)
spawn(function()
    while wait() do
        if FlowerESP then
            UpdateFlowerChams()
...
vu4.ToggleEspRealFruit:SetValue(false)
...
vu4.ToggleIslandMirageEsp:SetValue(false)
function isnil(p990)
    return p990 == nil
end
...
vu4.ToggleStart:SetValue(false)
spawn(function()
    while wait() do
        pcall(function()
...
vu3.Raid:AddToggle("ToggleNextIsland", {
    ["Title"] = "Auto Next Island & Clear Raid",
    ["Description"] = "",
    ["Default"] = false
...
vu4.ToggleNextIsland:SetValue(false)
spawn(function()
    local vu1005 = {}
    while task.wait() do
...
vu4.ToggleAwake:SetValue(false)
spawn(function()
    while task.wait() do
...
vu3.Race:AddToggle("ToggleHumanandghoul", {
    ["Title"] = "Auto Complete Trial [Human/Ghoul]",
    ["Description"] = "",
    ["Default"] = false
...
vu4.ToggleAutotrial:SetValue(false)
spawn(function()
    pcall(function()
        while wait() do
...
vu3.Race:AddToggle("ToggleKillTrial", {
    ["Title"] = "Kill Players (Trial)",
    ["Description"] = "",
    ["Default"] = false
}):OnChanged(function(p1054)
    _G.AutoKillTrial = p1054
end)
vu4.ToggleKillTrial:SetValue(false)
spawn(function()
    while wait() do
        pcall(function()
...
vu4.ToggleFarmRace:SetValue(false)
spawn(function()
	-- upvalues: (ref) vu1060
    while wait() do
        if vu1060 then
...
vu4.ToggleUpgrade:SetValue(false)
vu3.Shop:AddSection("Ability")
vu3.Shop:AddButton({
    ["Title"] = "Geppo",
    ["Description"] = "",
    ["Callback"] = function()
...
vu3.Shop:AddSection("Accessories")
vu3.Shop:AddButton({
    ["Title"] = "Black Cape",
    ["Description"] = "",
    ["Callback"] = function()
...
vu3.Shop:AddSection("Fightstyles")
vu3.Shop:AddButton({
    ["Title"] = "Black Leg",
    ["Description"] = "",
    ["Callback"] = function()
...
vu3.Shop:AddSection("Miscellaneous")
vu3.Shop:AddButton({
    ["Title"] = "Refund Stats",
    ["Description"] = "",
    ["Callback"] = function()
...
vu3.Misc:AddSection("TeamSelect")
vu3.Misc:AddButton({
    ["Title"] = "Join Pirates",
    ["Description"] = "",
    ["Callback"] = function()
...
vu3.Misc:AddSection("Awakening")
vu3.Misc:AddButton({
    ["Title"] = "Awakening Fruit",
    ["Description"] = "",
    ["Callback"] = function()
        game:GetService("Players").LocalPlayer.PlayerGui.Main.AwakeningToggler.Visible = true
    end
})
vu3.Misc:AddSection("Re")
...
vu4.ToggleRejoin:SetValue(true)
spawn(function()
    while wait() do
...
local v1099 = vu3.Sea:AddToggle("ToggleTPFrozenDimension", {
    ["Title"] = "Teleport to Leviathan Island",
    ["Description"] = "",
    ["Default"] = false
})
        ...
        pcall(function()
            ...
            while wait() do
                ...
                elseif v1103 == 0 then
                    ...
                    vu1102:SetDesc("Buy: " .. tostring(v1103))
                end
            end
        end)
    end)
...
vu3.Sea:AddToggle("ToggleHydraTree", {
    ["Title"] = "Auto Destroy Hydra Trees",
    ["Description"] = "",
    ["Default"] = false
...
vu3.Sea:AddParagraph({
    ["Title"] = "Draco V4 Status",
    ["Content"] = ""
})
vu3.Sea:AddToggle("ToggleTrialTeleport", {
    ["Title"] = "TP to Draco Trial Entrance",
    ["Description"] = "",
    ["Default"] = false
...
vu3.Sea:AddSection("PrehistoricIsland")
    ...
    pcall(function()
        ...
        while wait() do
            if game:GetService("Workspace").Map:FindFirstChild("PrehistoricIsland") then
                vu1150:SetDesc("Prehistoric Island Status: Found")
            else
                vu1150:SetDesc("Prehistoric Island Status: Not Found")
            end
        end
    end)
end)
vu3.Sea:AddToggle("ToggleTPVolcano", {
    ["Title"] = "TP to Prehistoric Island",
    ["Description"] = "",
    ["Default"] = false
}):OnChanged(function(p1151)
    _G.TweenToPrehistoric = p1151
end)
vu4.ToggleTPVolcano:SetValue(false)
spawn(function()
    local v1152 = nil
    while not v1152 do
...
vu3.Sea:AddToggle("ToggleKillAura", {
    ["title"] = "hit Golems Aura",
    ["Description"] = "",
    ["Default"] = false
}):OnChanged(function(p1200)
    KillAura = p1200
end)
vu4.ToggleKillAura:SetValue(false)
spawn(function()
    while wait() do
        if KillAura then
            pcall(function()
...
--=========================
-- REAPER ASSISTANT: UI 2 REPLACEMENT FOR UI 1
--=========================
...
button.Position = UDim2.new(0, 20, 0.5, -27) -- กึ่งกลางซ้าย
button.BackgroundTransparency = 0.2
button.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
button.Image = "rbxassetid://86279908104891" -- ใส่ ID รูปที่ต้องการตรงนี้
button.ZIndex = 999999
button.AutoButtonColor = false

local corner = Instance.new("UICorner")
corner.CornerRadius = UDim.new(1, 0) -- วงกลม
...
--=========================
-- TOGGLE LOGIC (Logic UI 1 + Effect UI 2)
--=========================
local isOpen = true
local LastClick = 0
...
local function ToggleMenu()
    local now = tick()
    if now - LastClick < 0.3 then return end -- Anti-spam
    LastClick = now
    ...
    TweenService:Create(Blur, TweenInfo.new(0.3), {
        Size = isOpen and 40 or 0
    }):Play()

    -- Simulate END Key (จาก UI 1)
    pcall(function()
    ...
    -- Library Support (ถ้ามีตัวแปร Window)
    if _G.Window then
